...
@ApiTags('System - Online Users Module')
@ApiSecurityAuth()
...
export class OnlineController {
  ...
  @Get('list')
  @ApiOperation({ summary: 'Query current online users' })
  @ApiResult({ type: [OnlineUserInfo] })
  @Perm(permissions.LIST)
  async list(@Req() req: Request): Promise<OnlineUserInfo[]> {
    return this.onlineService.listOnlineUser((req as any).accessToken)
  }

  @Post('kick')
  @ApiOperation({ summary: 'Kick specified online user' })
